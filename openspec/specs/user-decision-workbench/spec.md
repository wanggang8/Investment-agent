# user-decision-workbench Specification

## Purpose
Define the safe daily-use workbench that aggregates existing local discipline, portfolio, risk, rule, review, audit, and consultation entrypoints without adding execution or external integration capabilities.
