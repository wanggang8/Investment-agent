...
Capture decision-detail behavior that must remain explanatory, auditable, and non-trading, including expected return analysis and dynamic sell evaluation boundaries.
## Requirements
...
- **THEN** the system SHALL produce a sell evaluation or reassessment prompt in expected return material only, without adding it to the final verdict optional actions
