...
每个阶段建议独立提交；P19–P100 已作为当前本地源码交付基线完成并归档。P110 当前作为视觉系统重设计活跃 change，范围只覆盖前端视觉层级、tokens、核心页面审美一致性和响应式验收；不得借 P110 声称新增投资运行时能力、发布包刷新、物理第二机器复验、券商接口、自动交易、一键交易、代下单、外部推送、自动确认、自动规则应用、自动修复、真实库覆盖或收益承诺。
